...
var evt = {
    ...
    datbeg: utils.getValueByID("DATBEG"),
    tags_selected: [],
    ...
    loadTicketsView: function() {
        ...
        if (evt.isTicketsLoaded === false) {
            var jsonObj = {"UID": evt.uid, "DATBEG": evt.datbeg};
    ...
    loadTagsView: function() {
        var jsonObj = {"UID": this.uid, "DATBEG": evt.datbeg};
    ...
    onCancel: function() {
        var txtConfirm = document.getElementById('text_alert_cancelevent').value;
        var r = confirm(txtConfirm);
        if (r == true) {
            var jsonObj = {'UID' : evt.uid, "DATBEG": evt.datbeg};
    ...
    onEditTicket: function(e) {
        ...
        var jsonObj = {"UID": evt.uid, "DATBEG": evt.datbeg, "ID": id};
    ...
    onDeleteTickets: function(e) {
        var txtConfirm = document.getElementById('text_alert_deleteticket').value;
        var r = confirm(txtConfirm);
        if (r == true) {
            var id = $(this).data("ticket-id");
            var jsonObj = {"UID": evt.uid, "DATBEG": evt.datbeg, "ID": id};
