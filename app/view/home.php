...
try {
    ...
    $t->addResource('app/view/templates/trans/home.json');
    //--------------------------------------------
    ...
    echo '<script data-main="/ctrl/home" src="/dist/js/require.js"></script>';
    $this->stop();
    echo $this->insert('partials::home.tpl', $array);

} catch (Error $e) {
    error_log('home.php : ' . $e);
} finally {
    if (null !== $user) {
        $user->disconnect();
        unset($user);
