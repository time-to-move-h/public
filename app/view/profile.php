...
$this->start('scripts');
echo '<script data-main="/ctrl/profile" src="/dist/js/require.js"></script>';
...
$this->stop();
echo $this->insert('partials::profile.tpl', ['info' => $t, 'dataView' => $dataView , 'background_picture' => $background_picture, 'picture' => $picture, 'subscription' => $subscription, 'UUID' => $uid, 'admin' => $admin, 'lang' => $lang, 'sessionUser' => $sessionUser, 'params' => $params]);