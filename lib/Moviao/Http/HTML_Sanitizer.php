...
class HTML_Sanitizer
{
    ...
    public function addAllowedProtocols(array $protocols) : void
    {
        $this->allowed_protocols = (array)$protocols;
    }

    public function addAllowedTags(array $tags) : void
    {
        $this->allowed_tags = (array)$tags;
    }

    public function xss(string $string) : string
    {
    ...
    private function split(array $m) : string
    {
        $string = $m[1];
    ...
    private function attributes(string $attr) : array {
    ...
    private function badProtocol(string $string) : string {

        $string = html_entity_decode($string, ENT_QUOTES, 'UTF-8');
        return htmlspecialchars($this->stripDangerousProtocols($string), ENT_QUOTES, 'UTF-8');
    }

    private function stripDangerousProtocols(string $uri) : string
    {
