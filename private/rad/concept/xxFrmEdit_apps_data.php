...
<form action="<?php echo $page; ?>" method="post" name="F4" id="F4">
<div class="CSSTableGenerator">
<table width="500" border="1" align="center">  
        <tr>
          <td height="12" colspan="2"><div align="center">4</div></td>
          </tr>
