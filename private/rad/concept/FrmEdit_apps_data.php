...
// Ajout
function add($IDAPP,$TAB,$LIBELLE,$DESCRIPTION,$REQUETE,$IDENG,$FILE) {
	global $data,$util;			
	...
	$strSql = "INSERT INTO apps_data (DESCRIPTION, FILE, IDAPP, IDENG, LIBELLE, REQUETE, TAB) VALUES (";
	$strSql .= ((strlen($DESCRIPTION) <= 0) ? "NULL" :  "'$DESCRIPTION'");
	$strSql .= ", " . ((strlen($FILE) <= 0) ? "NULL" :  "'$FILE'");
...
// Modification
function modify($DESCRIPTION, $FILE, $IDAPP, $IDAPPDAT, $IDENG, $LIBELLE, $REQUETE, $TAB) {
	global $data, $util, $DESCRIPTION_ori, $FILE_ori, $IDAPP_ori, $IDAPPDAT_ori, $IDENG_ori, $LIBELLE_ori, $REQUETE_ori, $TAB_ori;
	...
	if ($FILE !== null && $FILE_ori !== null && $FILE != addslashes($FILE_ori)) $strSql_Req .= ((strlen($strSql_Req) > 0) ? " , " : "") . "FILE = '$FILE'";
...
$FILE = trim(isset($_POST['EFILE']) ? $_POST['EFILE'] : '');
...
if (! test($IDAPP, $IDAPPDAT)) {					
    if (add($IDAPP,$TAB,$LIBELLE,$DESCRIPTION,$REQUETE,$IDENG,$FILE)) {
...
if (test($IDAPP, $IDAPPDAT)) {		
    if (modify($DESCRIPTION, $FILE, $IDAPP, $IDAPPDAT, $IDENG, $LIBELLE, $REQUETE, $TAB)) {				
...
<table width="500" border="1" align="center">  
        ...
        <tr>
<td>ID APP</td>
<td><input type="text" size="30" name="EIDAPP" id="EIDAPP" value="<?php echo htmlspecialchars($IDAPP, ENT_COMPAT,'UTF-8', true); ?>"></td>
</tr>
<tr>
<td>ID Apps Data</td>
<td><input type="text" size="30" name="EIDAPPDAT" id="EIDAPPDAT" value="<?php echo htmlspecialchars($IDAPPDAT, ENT_COMPAT,'UTF-8', true); ?>"></td>
</tr>
<tr>
<td>Table</td>
<td><input type="text" size="30" name="ETAB" id="ETAB" value="<?php echo htmlspecialchars($TAB, ENT_COMPAT,'UTF-8', true); ?>"></td>
</tr>
<tr>
<td>Libelle</td>
<td><input type="text" size="30" name="ELIBELLE" id="ELIBELLE" value="<?php echo htmlspecialchars($LIBELLE, ENT_COMPAT,'UTF-8', true); ?>"></td>
</tr>
<tr>
<td>Description</td>
<td><input type="text" size="30" name="EDESCRIPTION" id="EDESCRIPTION" value="<?php echo htmlspecialchars($DESCRIPTION, ENT_COMPAT,'UTF-8', true); ?>"></td>
</tr>
<tr>
<td>Requete</td>
<td><input type="text" size="30" name="EREQUETE" id="EREQUETE" value="<?php echo htmlspecialchars($REQUETE, ENT_COMPAT,'UTF-8', true); ?>"></td>
</tr>
<tr>
<td>Engine</td>
<td><input type="text" size="30" name="EIDENG" id="EIDENG" value="<?php echo htmlspecialchars($IDENG, ENT_COMPAT,'UTF-8', true); ?>"></td>
</tr>
<tr>
<td>File Name</td>
<td><input type="text" size="30" name="EFILE" id="EFILE" value="<?php if ($FILE !== null) echo  htmlspecialchars($FILE); ?>"></td>
</tr>
